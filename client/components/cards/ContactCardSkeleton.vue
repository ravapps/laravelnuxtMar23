    ...
    <div class="w-full flex items-center justify-between p-6 space-x-6">
      <div class="flex-1 truncate">
        <div class="flex items-center space-x-3">
          <h3 class="text-gray-900 text-sm leading-5 font-medium truncate  w-32">
          dd ddddd
          </h3>
        </div>
        <p class="mt-1 text-gray-500 text-sm leading-5 truncate  w-36">
          aa aaaaa
        </p>
      </div>
      <div class="w-10 h-10 rounded-full flex-shrink-0 overflow-hidden " ><img src="laranuxt.png" /></div>
    </div>
